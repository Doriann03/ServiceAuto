...
--
-- Table structure for table `Lucrare_Angajat`
--

DROP TABLE IF EXISTS `Lucrare_Angajat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Lucrare_Angajat` (
  `IDL` int NOT NULL,
  `IDAngajat` int NOT NULL,
  PRIMARY KEY (`IDL`,`IDAngajat`),
  KEY `IDAngajat` (`IDAngajat`),
  CONSTRAINT `Lucrare_Angajat_ibfk_1` FOREIGN KEY (`IDL`) REFERENCES `Lucrare` (`IDL`) ON DELETE CASCADE,
  CONSTRAINT `Lucrare_Angajat_ibfk_2` FOREIGN KEY (`IDAngajat`) REFERENCES `Angajat` (`IDAngajat`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Lucrare_Angajat`
--

LOCK TABLES `Lucrare_Angajat` WRITE;
/*!40000 ALTER TABLE `Lucrare_Angajat` DISABLE KEYS */;
/*!40000 ALTER TABLE `Lucrare_Angajat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping routines for database 'dn198'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_returns_string` */;
...
DELIMITER ;;
CREATE DEFINER=`dn198`@`%` PROCEDURE `sp_returns_string`(OUT p_string VARCHAR(100))
BEGIN

                    SET p_string = 'Hello from stored procedure';
...
-- Dump completed on 2025-12-17 21:48:55
